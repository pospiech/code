...
*   \date    $Date: 2010/03/10 $
*   \version $PRODUCTVERSION: 3.60 $
*   \version $Revision: 70 $
*
...
#   define UEYE_VERSION_CODE   UEYE_VERSION(3, 60, 0)
#endif
...
#define IS_ENABLE_REDUCED_PIXEL_CLOCK       0x8002
#define IS_DISABLE_REDUCED_PIXEL_CLOCK      0x8003
#define IS_GET_REDUCED_PIXEL_CLOCK          0x8004

#define IS_REDUCED_PIXEL_CLOCK_ENABLED      1
#define IS_REDUCED_PIXEL_CLOCK_DISABLED     0
...
#define IS_SET_SENS_AUTO_SHUTTER_PHOTOM     0x801E // set sensor auto shutter photometry
#define IS_SET_SENS_AUTO_GAIN_PHOTOM        0x801F // set sensor auto gain photometry
#define IS_GET_SENS_AUTO_SHUTTER_PHOTOM     0x8020 // get sensor auto shutter photometry
#define IS_GET_SENS_AUTO_GAIN_PHOTOM        0x8021 // get sensor auto gain photometry
#define IS_GET_SENS_AUTO_SHUTTER_PHOTOM_DEF 0x8022 // get default sensor auto shutter photometry
#define IS_GET_SENS_AUTO_GAIN_PHOTOM_DEF    0x8023 // get default sensor auto gain photometry
...
typedef enum E_AUTO_SHUTTER_PHOTOM
{
    ...
    AS_PM_SENS_PROTRAIT         = 0x00000004, // sensor auto shutter: portrait
...
typedef enum E_AUTO_GAIN_PHOTOM
{
    ...
    AG_PM_SENS_PROTRAIT         = 0x00000004, // sensor auto gain: portrait
